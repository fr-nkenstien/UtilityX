...
--------------------------------------------------------
  ...
  CREATE TABLE "JARSPEM"."DATA_LOOKUPS" 
   (	"LOOKUP_KEY" VARCHAR2(100 BYTE), 
	"DATA_CODE" VARCHAR2(100 BYTE), 
...
SET DEFINE OFF;
Insert into JARSPEM.DATA_LOOKUPS (LOOKUP_KEY,DATA_CODE,DATA_NAME,DATA_VALUE,STATUS) values ('OBJECT_STATUS','ACTIVE','Active','A','A');
Insert into JARSPEM.DATA_LOOKUPS (LOOKUP_KEY,DATA_CODE,DATA_NAME,DATA_VALUE,STATUS) values ('OBJECT_STATUS','INACTIVE','Inactive','I','A');
Insert into JARSPEM.DATA_LOOKUPS (LOOKUP_KEY,DATA_CODE,DATA_NAME,DATA_VALUE,STATUS) values ('PROJECT_TYPE','FIXED','Fixed Type','FIXED','A');
Insert into JARSPEM.DATA_LOOKUPS (LOOKUP_KEY,DATA_CODE,DATA_NAME,DATA_VALUE,STATUS) values ('PROJECT_TYPE','UNIT','Unit Price','UNIT','A');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "JARSPEM"."SPRINT_TASK_DETAILS_UK1" ON "JARSPEM"."SPRINT_TASK_DETAILS" ("SPRINT_ID", "TASK_CODE") 
  ;
--------------------------------------------------------
--  DDL for Index SPRINT_TASK_DETAILS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "JARSPEM"."SPRINT_TASK_DETAILS_PK" ON "JARSPEM"."SPRINT_TASK_DETAILS" ("TASK_ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index RESOURCE_ALLOCATION_DETAI_UK1
--------------------------------------------------------

  CREATE UNIQUE INDEX "JARSPEM"."RESOURCE_ALLOCATION_DETAI_UK1" ON "JARSPEM"."RESOURCE_ALLOCATION_DETAILS" ("RID", "TASK_ID", "START_DATE", "END_DATE") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table RESOURCE_ALLOCATION_DETAILS
--------------------------------------------------------

  ALTER TABLE "JARSPEM"."RESOURCE_ALLOCATION_DETAILS" ADD CONSTRAINT "RESOURCE_ALLOCATION_DETAI_UK1" UNIQUE ("RID", "TASK_ID", "START_DATE", "END_DATE") ENABLE;
 
  ALTER TABLE "JARSPEM"."RESOURCE_ALLOCATION_DETAILS" MODIFY ("RID" NOT NULL ENABLE);
 
  ALTER TABLE "JARSPEM"."RESOURCE_ALLOCATION_DETAILS" MODIFY ("TASK_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Ref Constraints for Table RESOURCE_ALLOCATION_DETAILS
--------------------------------------------------------

  ALTER TABLE "JARSPEM"."RESOURCE_ALLOCATION_DETAILS" ADD CONSTRAINT "RESOURCE_ALLOCATION_DETAI_FK1" FOREIGN KEY ("RID")
	  REFERENCES "JARSPEM"."RESOURCE_DETAILS" ("RID") ON DELETE CASCADE ENABLE;
 
  ALTER TABLE "JARSPEM"."RESOURCE_ALLOCATION_DETAILS" ADD CONSTRAINT "RESOURCE_ALLOCATION_DETAI_FK2" FOREIGN KEY ("TASK_ID")
	  REFERENCES "JARSPEM"."SPRINT_TASK_DETAILS" ("TASK_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "JARSPEM"."SPRINT_TASK_DETAILS" ADD CONSTRAINT "SPRINT_TASK_DETAILS_FK1" FOREIGN KEY ("SPRINT_ID")
	  REFERENCES "JARSPEM"."SPRINT_DETAILS" ("SPRINT_ID") ON DELETE CASCADE ENABLE;
