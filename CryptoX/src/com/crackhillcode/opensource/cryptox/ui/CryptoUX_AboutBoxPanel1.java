...
public class CryptoUX_AboutBoxPanel1 extends JPanel {
    ...
    public CryptoUX_AboutBoxPanel1() {
        try {
            jbInit();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jbInit() throws Exception {
        ...
        labelTitle.setText("Utility Name: CryptoX");
        labelAuthor.setText("Author: Vineet Verma");
        labelCopyright.setText("Open Source Licence");
